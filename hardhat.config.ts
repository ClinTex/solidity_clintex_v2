...
function getChainConfig(network: keyof typeof chainIds): NetworkUserConfig {
  const infuraUrl: string = "https://" + network + ".infura.io/v3/" + infuraApiKey;
  const mumbaiUrl: string = "https://polygon-mumbai.g.alchemy.com/v2/" + alchemyApiKey;
  const url = network === "polygonMumbai" ? mumbaiUrl : infuraUrl;
  return {
    accounts: {
      count: 10,
      mnemonic,
